    ...
    return (
        <React.Fragment>
            <a
                ...
                target="_blank"
                rel="noreferrer"
                className={`group flex items-center rounded-2xl bg-white py-2 px-3 md:py-3 mb-4 md:px-4 last:mb-0 transition-all outline-none border-2 hover:scale-105 text-zinc-700 ${
